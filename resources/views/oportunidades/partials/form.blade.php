...
<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <hr>
        <div class="form-group">
            {{ Form::label('id_cliente', 'Seleccione un Cliente:') }}
        ...
        <div class="form-group">
        {{ Form::label('nombre', 'Nombre de referencia para la oportunidad') }}
        ...
        <div class="form-group">
            ...
            {{ Form::number('monto_esperado', $oportunidad->monto_esperado, ['class' => 'form-control' . ($errors->has('monto_esperado') ? ' is-invalid' : ''),  'placeholder' => 'Ingrese el monto que se estima ganar con esta oportunidad','step' => '0.01']) }}
